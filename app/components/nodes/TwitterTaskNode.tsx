    ...
    >
      ...
      >
        <div className="flex items-center gap-2 text-white">
          ...
          <span className="font-bold text-sm">Twitter Task</span>
        </div>
      </div>
      ...
      <div className="bg-slate-900/95 backdrop-blur-xl p-3 border-t border-white/5 select-none rounded-b-xl">
        <div className="space-y-1">
          <div className="text-xs font-medium" style={{ color: accentColor }}>
            ...
            {taskType === "like" && "❤️ Like"}
            {taskType === "retweet" && "🔄 Retweet"}
            {taskType === "quote" && "💬 Quote Tweet"}
          </div>
          <div className="text-[10px] text-slate-400 truncate">{target}</div>
        </div>
      </div>
